...
const displayChart = function(obj){
    ...
    `
    <div class="canvas-chart d-inline-block"><canvas id="chart-canvas-total-confirmed-cases" class="h-50 w-100 mt-5 p-3 bgwhiteoverlay"></canvas></div>
    <div class="canvas-chart d-inline-block"><canvas id="chart-canvas-daily-confirmed-cases" class="h-50 w-100 mt-5 p-3 bgwhiteoverlay"></canvas></div>
    <div class="canvas-chart d-inline-block"><canvas id="chart-canvas-total-deaths" class="h-50 w-100 mt-5 p-3 bgwhiteoverlay"></canvas></div>
    <div class="canvas-chart d-inline-block"><canvas id="chart-canvas-daily-deaths" class="h-50 w-100 mt-5 p-3 bgwhiteoverlay"></canvas></div>
    <div class="canvas-chart d-inline-block"><canvas id="chart-canvas-total-recovered" class="h-50 w-100 mt-5 p-3 bgwhiteoverlay"></canvas></div>
    <div class="canvas-chart d-inline-block"><canvas id="chart-canvas-daily-recovered" class="h-50 w-100 mt-5 p-3 bgwhiteoverlay"></canvas></div>`
